...
import { NewFunnelLoanRankSpeedometerSeva } from "./NewFunnelLoanRankSpeedometer";
...
export const NewFunnelLoanRankComponentSeva = ({
  ...
  return (
    ...
    >
      <NewFunnelLoanRankSpeedometerSeva
        borderTopRadius={borderTopRadius}
        borderBottomRadius={borderBottomRadius}
        loanRank={loanRank}
      />
